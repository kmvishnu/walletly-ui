  ...
  return (
    <div className="flex flex-col h-full bg-dark-blue ">
      <div className="flex-1 flex justify-between items-center ml-6">
        <p className="text-cream-white text-5xl mt-6">
          ₹5000 <span className="text-cream-white text-base ">Balance</span>
        </p>
      ...
      <div className="flex-1 flex justify-between items-center ml-2">
        ...
        <p className="text-cream-white text-2xl">
          ₹1000 <span className="text-cream-white text-base ">Spent</span>
        </p>
      </div>
    </div>
  );
